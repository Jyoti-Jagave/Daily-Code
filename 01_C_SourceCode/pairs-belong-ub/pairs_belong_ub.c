...
{
    int*p_array = NULL;
    /* ptr for storing base addr of array */

    int N;
    /* integer variable for storing size of array */

    int U;
    /* integer variable for storing the value of upper bound */

    int i;
    /* integer variable for indexing in loops */

    int j;
    /* integer variable for indexing in loop */
    ...
    /* 2. allocate storage for array of 'N' integers store the base address
                                                              of array in p_array */
    ...
    /* 4. Input the for the upper bound from end user */
